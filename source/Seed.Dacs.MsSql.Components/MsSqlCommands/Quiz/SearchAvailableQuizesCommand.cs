...
{
    internal class SearchAvailableQuizesCommand : BaseCommand<QuizList>
    {
        private QuizList _result;
        private long _userId;

        public SearchAvailableQuizesCommand(long userId)
        {
            StoredProcedureName = SeedStoredProcedures.SearchQuizzes;
            _userId = userId;
